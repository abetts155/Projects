...
public class CallGraph extends DirectedGraph
{
    ...
    {
        assert nameToVertex.containsKey(subprogramName) : "Unable to find call graph vertex for subprogram '"
                + subprogramName + "'";
    ...
    {
        return (CallVertex) super.getVertex(vertexID);
    }
    ...
    public final void addCall (String caller, String callee, int callSiteID)
    {
        ...
        Debug.debugMessage(getClass(),
                "Adding call from subprogram '" + caller + "' to subprogram '"
                        + callee + "' at call site " + callSiteID, 4);
    }
    ...
    public final void addCall (int callerID, int calleeID, int callSiteID)
    {
        ...
        Debug.debugMessage(getClass(), "Adding call from subprogram "
                + callerID + " to subprogram " + calleeID + " at call site "
                + callSiteID, 4);
    }
