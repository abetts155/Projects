...
import adam.betts.vertices.call.SubprogramVertex;
...
public class CallLoopGraph extends DirectedGraph
{
    ...
    private void addEdges (DepthFirstTree dfs)
    {
        ...
        for (int i = dfs.numOfVertices(); i >= 1; --i)
        {
            ...
            Debug.debugMessage(getClass(),
                    "Analysing subprogram " + subprogram.getSubprogramName(), 4);
            ...
            Subprogram subprogram)
    {
        ...
        while (!loopsAdded.contains(headerID) && headerID != entryID)
        {
            ...
            LoopVertex loopv = new LoopVertex(vertexID,
                    subprogram.getSubprogramID(),
                    subprogram.getSubprogramName(), headerID);
            ...
            Set <LoopVertex> verticesAdded, int entryID, Subprogram subprogram)
    {
        for (int headerID : loopsAdded)
        {
            ...
            Debug.debugMessage(getClass(),
                    "Adding edge " + predID + " => " + v.getVertexID(), 4);
        }
    }
    ...
    private class CheckGraphProperties
    {
        ...
        private CheckGraphProperties ()
        {
            ...
            {
                Debug.debugMessage(getClass(), "Too many roots found in CLDS: "
                        + noPreds, 1);
                System.exit(1);
            }
            ...
            if (noSuccs.size() != 0)
            {
                ...
                for (LoopVertex v : noSuccs)
                {
                    Debug.debugMessage(getClass(), "Vertex " + v.getVertexID()
                            + " modelling the loop " + v.getHeaderID() + " in "
