        ...
        try
        {
            ...
            if (line.endsWith("ss-coff-little"))
            {
                ...
                unconditionalBranch = new HashSet <String>(
                        Arrays.asList(new String[] { jInstruction }));
            ...
            else if (line.endsWith("elf32-littlearm"))
            {
                ...
                branches = new HashSet <String>(Arrays.asList(new String[] {
                        ...
                        bleDotnInstruction, blsDotnInstruction,
            ...
            else if (line.endsWith("elf64-alpha"))
            {
                ...
                unconditionalBranch = new HashSet <String>(
                        Arrays.asList(new String[] { brInstruction }));
            ...
            else if (line.endsWith("elf32-sparc"))
            {
                ...
                unconditionalBranch = new HashSet <String>(
                        Arrays.asList(new String[] { bInstruction,
                                retInstruction, retlInstruction }));
            ...
            else if (line.endsWith("elf32-i386"))
            {
                ...
                unconditionalBranch = new HashSet <String>(
                        Arrays.asList(new String[] { jmpInstruction }));
                subprogramCall = callInstruction;
                isa = ISA.X86;
                numberOfBytesPerInstruction.add(4);
            }
            ...
            {
                Debug.errorMessage(getClass(), "Disassembly first line " + line
                        + programFileName + " is not a valid disassembly file");
            }
        }
        catch (Exception e)
        {
