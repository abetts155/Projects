...
public class AnalysisOutput
{
    ...
    public AnalysisOutput (Program program, LoopBoundDatabase database)
    {
        ...
        System.out.println("**************************");
        System.out.println("***** BOUND LEVEL: "
                + MainLoopAnalyser.getBoundLevel() + " *****");
        System.out.println("**************************\n");
        ...
        for (int i = 1; i <= dfs.numOfVertices(); i++)
        {
            ...
            System.out.println("Subprogram: "
                    + subprogram.getSubprogramName().toUpperCase());
            ...
            {
                final String tableHeader = "|" + headerColumn + "|"
                        + ancestorColumn + "|" + boundColumn + "|";
                        ...
                        if (v instanceof HeaderVertex)
                        {
                                    ...
                                    .getProperAncestors(vertexID))
                            {
                                        ...
                                        .getBoundLevel())
                                {
                                    ...
                                    int bound = database.getBound(subprogramID,
                                            vertexID, ancestorID);
