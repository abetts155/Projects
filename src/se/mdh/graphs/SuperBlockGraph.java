...
import se.mdh.graphs.utils.StronglyConnectedComponents;
...
public class SuperBlockGraph extends DirectedGraph
{
	...
	public SuperBlockGraph (ControlFlowGraph cfg)
	{
		this.cfg = cfg.clone ();
	...
	private class DominatorGraph extends DirectedGraph
	{
		...
		private void addEdges ()
		{
			...
			DominatorTree postdomt = new DominatorTree (reverseg, cfg
					.getExitID (), DominatorTreeType.POST_DOMINATOR);
