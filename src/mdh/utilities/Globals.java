...
import se.mdh.tools.MainWCETAnalyser;
import se.mdh.utilities.Enums.IProfile;
import se.mdh.utilities.Enums.OutputFormats;
...
public class Globals
{
	...
	{
		Debug.debugMessage (Globals.class, "Program file is " + value, 1);
		programFileName = value;
	}

	public final static String getProgramFileName ()
	{
