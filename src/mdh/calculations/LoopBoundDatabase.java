			...
			for (int vertexID: transition.getEdgeLabel ())
			{
				...
				if (analyse)
				{
					...
					while (ancestorID != lnt.getRootID ())
					{
						...
						if (headerv.getLevel () - ancestorv.getLevel () <= se.mdh.tools.MainLoopAnalyser.Globals
								.getBoundLevel ())
						{
							Debug.debugMessage (getClass (),
						...
						.contains (uParentID))
				{
							...
							.get (lcaID))
					{
						...
						while (ancestorID != lnt.getRootID ())
						{
							...
							if (descendantv.getLevel () - ancestorv.getLevel () <= se.mdh.tools.MainLoopAnalyser.Globals
									.getBoundLevel ())
							{
