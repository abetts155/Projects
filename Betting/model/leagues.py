...
league_register = OrderedDict({
    ...
    'DNK3A': League('Denmark', 'Denmark Series - Group 1'),
    'DNK3B': League('Denmark', 'Denmark Series - Group 2'),
    'DNK3C': League('Denmark', 'Denmark Series - Group 3'),
    ...
    'RUS3A': League('Russia', 'PFL - Center'),
    'RUS3B': League('Russia', 'PFL - South'),
    'RUS3C': League('Russia', 'PFL - Ural-Povolzhye'),
    'RUS3D': League('Russia', 'PFL - West'),
    ...
    'THA2': League('Thailand', 'Thai League 1'),
