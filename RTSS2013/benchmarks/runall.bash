...
python ../src/ToolSuperBlocks.py duffsdevice.txt
...
python ../src/ToolSuperBlocks.py exponential_integral.txt
python ../src/ToolGem5.py factorial.c -r factorial
python ../src/ToolSuperBlocks.py factorial.txt
...
python ../src/ToolSuperBlocks.py fibonacci.txt
