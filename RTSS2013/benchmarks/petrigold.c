...
/*   dummy_i = 17; Takes too much time */
  ...
  printf("P1_is_marked = %d\n", P1_is_marked);
  printf("P2_is_marked = %d\n", P2_is_marked);
  printf("P3_is_marked = %d\n", P3_is_marked);
  
  int i;
  
  for (i=0;i<3;++i)
     printf("P1_marking_member_0[%d]= %ld\n", i, P1_marking_member_0[i]);
  for (i=0;i<5;++i)
     printf("P2_marking_member_0[%d]= %ld\n", i, P2_marking_member_0[i]);
  for (i=0;i<6;++i)
     printf("P3_marking_member_0[%d]= %ld\n", i, P3_marking_member_0[i]);
